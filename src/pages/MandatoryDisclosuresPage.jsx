        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            {documents.map((doc) => (
              <div
                key={doc.file}
                className="bg-surface-container-lowest p-5 lg:p-6 rounded-xl border-l-4 border-transparent hover:border-secondary transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl group"
              >
                <div className="bg-surface-container-low p-4 rounded-lg text-secondary group-hover:bg-secondary group-hover:text-white transition-colors inline-block mb-6">
                  <span aria-hidden="true" className="material-symbols-outlined text-3xl">{doc.icon}</span>
                </div>
