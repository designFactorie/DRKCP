    ...
    <main className="bg-surface">
      ...
      <section className="relative min-h-[300px] md:min-h-[340px] pt-28 pb-12 px-5 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl xl:text-6xl text-white mb-4 leading-tight font-headline">Contact Us</h1>
      ...
      {/* Contact Cards */}
      <section className="py-12 md:py-16 px-5 sm:px-8 lg:px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          {/* Phone */}
          <div className="bg-white p-5 rounded-xl shadow-sm border-b-4 border-secondary transition-all hover:-translate-y-2 group">
            <div className="w-14 h-14 bg-secondary/10 flex items-center justify-center rounded-lg mb-6 group-hover:bg-secondary/20 transition-colors">
              <span aria-hidden="true" className="material-symbols-outlined text-secondary text-2xl">call</span>
            </div>
          ...
          {/* Email */}
          <div className="bg-white p-5 rounded-xl shadow-sm border-b-4 border-primary transition-all hover:-translate-y-2 group">
            <div className="w-14 h-14 bg-primary/10 flex items-center justify-center rounded-lg mb-6 group-hover:bg-primary/20 transition-colors">
              <span aria-hidden="true" className="material-symbols-outlined text-primary text-2xl">mail</span>
            </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border-b-4 border-secondary transition-all hover:-translate-y-2 group">
            <div className="w-14 h-14 bg-secondary/10 flex items-center justify-center rounded-lg mb-6 group-hover:bg-secondary/20 transition-colors">
              <span aria-hidden="true" className="material-symbols-outlined text-secondary text-2xl">location_on</span>
            </div>
          ...
          <div className="bg-white p-5 rounded-xl shadow-sm border-b-4 border-primary transition-all hover:-translate-y-2 group">
            <div className="w-14 h-14 bg-primary/10 flex items-center justify-center rounded-lg mb-6 group-hover:bg-primary/20 transition-colors">
              <span aria-hidden="true" className="material-symbols-outlined text-primary text-2xl">schedule</span>
            </div>
      ...
      {/* Contact Form & Map */}
      <section id="enquiry-form" className="py-12 md:py-16 px-5 sm:px-8 lg:px-10 bg-surface-container-low">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary italic leading-tight mb-4">We're Here to Help</h2>
            <p className="text-on-surface-variant leading-relaxed mb-10">
              Have a question about admissions, programs, or campus life? Contact our team by phone or email for assistance.
            </p>
            <EnquiryForm />
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex-1 rounded-xl overflow-hidden shadow-xl min-h-[280px] lg:min-h-[400px]">
              <iframe
            ...
            >
              <span aria-hidden="true" className="material-symbols-outlined">directions</span>
      ...
      <section className="py-12 md:py-16 px-5 sm:px-8 lg:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 lg:mb-10">
            <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-4 italic">Quick Connect</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-5 rounded-xl shadow-sm border-t-4 border-secondary">
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-16 px-5 sm:px-8 lg:px-10 bg-primary text-on-primary overflow-hidden relative">
        <div className="absolute right-0 bottom-0 opacity-10 pointer-events-none translate-x-1/4 translate-y-1/4">
          <span aria-hidden="true" className="material-symbols-outlined text-[400px]">school</span>
        </div>
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          <h2 className="text-3xl md:text-4xl xl:text-5xl font-headline font-bold mb-8 italic">Ready to Shape Your Future?</h2>
          ...
          <div className="mt-12 flex flex-col md:flex-row gap-4 justify-center">
            <button type="button" onClick={openEnquiry} className="bg-secondary text-white px-10 py-4 rounded-lg font-semibold text-lg hover:shadow-2xl hover:shadow-secondary/30 transition-all active:scale-95">
              Apply Now
            </button>
            <a
