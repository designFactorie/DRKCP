...
export default function Academics() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[300px] md:min-h-[360px] pt-28 pb-12 flex items-center overflow-hidden bg-primary-container">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-primary-fixed text-lg md:text-xl max-w-xl leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div className="lg:col-span-4">
              <h2 className="text-3xl sm:text-4xl font-headline text-primary leading-tight mb-8">Courses Offered</h2>
            ...
            <div className="lg:col-span-8">
              <div role="region" aria-label="Course comparison, scroll horizontally on small screens" tabIndex={0} className="overflow-x-auto bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant/10">
                <table className="min-w-[520px] w-full text-left border-collapse">
                  <thead className="bg-surface-container-low">
                    <tr>
                      <th className="px-4 py-4 text-sm font-bold text-primary uppercase tracking-wider">Program Name</th>
                      <th className="px-4 py-4 text-sm font-bold text-primary uppercase tracking-wider">Abbreviation</th>
                      <th className="px-4 py-4 text-sm font-bold text-primary uppercase tracking-wider">Duration</th>
                    </tr>
                  </thead>
      ...
      <section className="py-12 md:py-16 px-5 sm:px-8 bg-surface-container-low">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8" onMouseLeave={() => setActiveAdmission('bpharm')}>
            ...
            <div
              ...
              className={`p-5 lg:p-8 rounded-xl transition-all duration-500  ${
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'dpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Duration</p>
                  <p className={`transition-colors duration-500 ${activeAdmission === 'dpharm' ? 'text-white' : 'text-on-surface'}`}>2 Years Full-Time</p>
                </div>
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'dpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Eligibility</p>
                ...
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'dpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Documents Required</p>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'bpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Duration</p>
                  <p className={`transition-colors duration-500 ${activeAdmission === 'bpharm' ? 'text-white' : 'text-on-surface'}`}>4 Years (8 Semesters)</p>
                </div>
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'bpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Eligibility</p>
                ...
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'bpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Documents Required</p>
                  <ul className="mt-3 space-y-2">
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'mpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Duration</p>
                  <p className={`transition-colors duration-500 ${activeAdmission === 'mpharm' ? 'text-white' : 'text-on-surface'}`}>2 Years (4 Semesters)</p>
                </div>
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'mpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Eligibility</p>
                ...
                <div>
                  <p className={`text-xs font-bold uppercase tracking-widest mb-2 transition-colors duration-500 ${activeAdmission === 'mpharm' ? 'text-primary-fixed' : 'text-secondary'}`}>Documents Required</p>
                  <ul className="mt-3 space-y-2">
      ...
      <section className="py-12 md:py-16 bg-surface">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <h2 className="text-3xl sm:text-4xl font-headline text-primary mb-8 lg:mb-10 border-l-4 border-secondary pl-6">
          ...
          <div className="space-y-12 lg:space-y-16">
            ...
            {/* B.Pharm Detail */}
            <div id="bpharm" className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <div className="flex items-center gap-4 mb-4">
      ...
      <section className="py-12 md:py-16 bg-surface-container-low px-5 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:p-8" onMouseLeave={() => setActivePathway('bpharm')}>
            {/* D.Pharm Pathways */}
            <div
              onMouseEnter={() => setActivePathway('dpharm')}
              className={`flex flex-col p-5 lg:p-8 rounded-2xl transition-all duration-500  ${
            ...
            >
              ...
              <div className="space-y-8 flex-grow">
                <div>
                  ...
                  <p className={`transition-colors duration-500 ${activePathway === 'dpharm' ? 'text-primary-fixed text-sm' : 'text-on-surface-variant'}`}>Pursue Bachelor of Pharmacy (B.Pharm) through lateral entry programs.</p>
                </div>
                <div>
                  ...
                  <p className={`leading-relaxed text-sm transition-colors duration-500 ${activePathway === 'dpharm' ? 'text-primary-fixed' : 'text-on-surface-variant'}`}>
                ...
                <div>
                  ...
                  <p className={`transition-colors duration-500 ${activePathway === 'dpharm' ? 'text-primary-fixed text-sm' : 'text-on-surface-variant'}`}>Beyond employment, diploma holders are qualified to open and operate their own retail chemist shops.</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl mb-6 transition-colors duration-500 ${
                ...
                <span aria-hidden="true" className="material-symbols-outlined text-3xl">work_history</span>
              </div>
              ...
              <div className="space-y-8 flex-grow">
                <div>
                  ...
                  <p className={`text-sm transition-colors duration-500 ${activePathway === 'bpharm' ? 'text-primary-fixed' : 'text-on-surface-variant'}`}>
                ...
                <div>
                  ...
                  <div className={`grid grid-cols-2 gap-x-4 gap-y-2 text-xs pt-1 transition-colors duration-500 ${activePathway === 'bpharm' ? 'text-primary-fixed' : 'text-on-surface-variant'}`}>
            ...
            >
              <div className={`inline-flex items-center justify-center w-14 h-14 rounded-xl mb-6 transition-colors duration-500 ${
                ...
                <span aria-hidden="true" className="material-symbols-outlined text-3xl">biotech</span>
              </div>
              ...
              <div className="space-y-8 flex-grow">
                <div>
                  ...
                  <p className={`transition-colors duration-500 ${activePathway === 'mpharm' ? 'text-primary-fixed text-sm' : 'text-on-surface-variant'}`}>
                ...
                <div>
                  ...
                  <p className={`text-sm transition-colors duration-500 ${activePathway === 'mpharm' ? 'text-primary-fixed' : 'text-on-surface-variant'}`}>
      ...
      <section className="py-12 md:py-16 px-5 sm:px-8 relative isolate">
        ...
        <div className="max-w-4xl mx-auto glass-card p-6 lg:p-8 rounded-2xl shadow-2xl">
          <div className="text-center mb-12">
            <span aria-hidden="true" className="material-symbols-outlined text-5xl text-secondary mb-4">assignment_turned_in</span>
            <h2 className="text-3xl sm:text-4xl font-headline text-primary">Examination Protocols</h2>
            <div className="w-20 h-1 bg-secondary mx-auto mt-4"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-primary flex items-center gap-2">
                <span aria-hidden="true" className="material-symbols-outlined text-secondary">analytics</span> Evaluation System
              </h4>
            ...
            <div className="space-y-6">
              <h4 className="text-xl font-bold text-primary flex items-center gap-2">
                <span aria-hidden="true" className="material-symbols-outlined text-secondary">verified</span> Passing Criteria
              </h4>
              <p className="text-on-surface-variant leading-relaxed">
